...
SensorResult PressureSensor::getDecodedData()
{
	...
	switch (statusRaw)
	{
	case 0:     results.statusStr = "Normal";   break;
	case 1:     results.statusStr = "Reserved"; break; // should not be seen during normal operation
	case 2:     results.statusStr = "Stale ";   break;
	case 3:     results.statusStr = "Fault ";   break;
	default:    results.statusStr = "Error ";
	}
